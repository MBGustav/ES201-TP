...
GEM5_PATH="/workspace/gem5-stable"
GEM5_BIN="$GEM5_PATH/build/ARM/gem5.fast"
GEM5_CONFIG="$GEM5_PATH/configs/example/se.py"
APP_BIN="/workspace/m5threads/tests/test_omp"
...
# Output: root
OUTPUT_ROOT="${OUTPUT_ROOT:-/workspace/TP5/CORTEXA15/results}"
